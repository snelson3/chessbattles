...
class vtk441MapperPart3 : public vtk441Mapper
{
 public:
   ...
   double earSize, earAngle, earHeight;
   double earAngle2;
   double mouthSize, mouthHeight, mouthGap;
   double noseSize;
   double tongueSize;
   double bodySize;
   double legSize, footSize;
   double tailSize, neckSize;
   ...
   void DrawTongue(void)
   {
    glPushMatrix();
    Pink();
    glScalef(tongueSize,tongueSize/4,tongueSize/3);
    DrawSphere();
    glPopMatrix();
   }
   ...
   void DrawNose(void)
   {
    ...
    Black();
    glScalef(noseSize/3,noseSize/5,noseSize/3);
    DrawSphere();
    glPopMatrix();
   }
   ...
   void DrawTail(void)
   {
    ...
    glRotatef(90,0,0,0);
    glRotatef(45,0,0,-1);
    glScalef(tailSize/3,tailSize*3,tailSize/3);
    glRotatef(90,0,0,0);
    //glRotatef(35,0,0,0);
    DrawCylinder();
    glPopMatrix();
  ...
  void DrawNeck(void)
   {
    ...
    glRotatef(90,0,0,0);
    glRotatef(45,0,0,-1);
    glScalef(neckSize/3,neckSize*2,neckSize/3);
    glRotatef(90,0,0,0);
    glTranslatef(-1,0,-1);
    //glRotatef(35,0,0,0);
    DrawCylinder();
   ...
   void DrawMouth(void)
   {
       glPushMatrix();
       Grey();
       glScalef(mouthSize/3,mouthSize,mouthSize/3);
       DrawSphere();
       //nose
       // glTranslatef(1,0,0.2);
       // Green();
       // glPushMatrix();
       // glScalef(noseSize*2,noseSize,noseSize);
       // DrawSphere();
       // // glPopMatrix();
       // glTranslatef(-1,0,-0.2);
       DrawNose();
       //Tongue
        glTranslatef(0,0,mouthGap/2);
        // mouthSize = mouthSize*(2/3);
        DrawTongue();
        glTranslatef(0,0,mouthGap/2);
        Grey();
   ...
   void DrawEar(int i)
   {
      glPushMatrix();
      Brown();
      glRotatef(20*i,0,0,0);

      glScalef(earSize/2,earSize/3,earSize);
   ...
   void DrawFoot(void)
   {
    ...
    glScalef(footSize*2.6,footSize*1.65,0.01);
   ...
   void DrawLeg(void)
   {
    glPushMatrix();
    Blue();
    glScalef(legSize/3,legSize/3,legSize*3);
    DrawCylinder();
    glTranslatef(0,0,0);
    DrawFoot();
    glPopMatrix();
   ...
   virtual void RenderPiece(vtkRenderer *ren, vtkActor *act)
   {
    //Do all your stuff here.
       ...
       //ears
       //angleRadians = earAngle/360.0 * 2 * 3.14159;
       //mag = (1*1-earHeight*earHeight)*(1-earSize/2);

       glPushMatrix();
       //glTranslatef(mag*cos(angleRadians), mag*sin(angleRadians), earHeight);
       glTranslatef(0,1,earHeight);
       DrawEar(1);
       glPopMatrix();

       earAngle2 = earAngle2 * -1;
      ...
      glPopMatrix();
       ...
       glPushMatrix();
       Black();
       glScalef(bodySize,bodySize/1.3,bodySize/1.44);
       glTranslatef(-1.48,0,-1.043);
       DrawSphere();

       //Back Right leg
       glPushMatrix();
       glTranslatef(-.36,-.66,-legSize*3.5);
       DrawLeg();
       glPopMatrix();
